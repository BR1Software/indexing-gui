...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.inc_emails = customtkinter.CTkSwitch(self, text="Inc. Emails", command=self.switch_event, variable=switch_var, onvalue="on", offvalue="off")
        self.inc_emails.grid(row=0, column=2, padx=10, pady=10, sticky="ew")
